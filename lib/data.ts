...
/* Real bestseller products — cards link out to their live pages on shop.mahidha.com. */
export const BESTSELLERS: Product[] = [
  {
    id: "emerald-muse-necklace",
    name: "Emerald Muse Necklace",
    ...
    oldPrice: 16666,
    rating: 5,
    desc: "A long freshwater pearl wrap necklace accented with deep emerald-toned natural stones for a rich, contemporary statement.",
    img: ["Emerald Muse Necklace"],
    pics: ["/img/Emerald-Muse-Necklace-2.png"],
    shopUrl: "https://shop.mahidha.com/product/emerald-muse-necklace/",
  },
  {
    id: "chaandrika-studs",
    name: "Chaandrika Studs",
    category: "Celestial Studs",
    style: "Earrings",
    material: "925 Sterling Silver",
    price: 13999,
    oldPrice: 15554,
    rating: 5,
    desc: "Crescent-moon studs handcrafted in sterling silver with rich gold plating and intricate Kundan Jadau-style detailing.",
    img: ["Chaandrika Studs"],
    pics: ["/img/Chaandrika-Studs-3.png"],
    shopUrl: "https://shop.mahidha.com/product/chaandrika-studs/",
  },
  {
    id: "surkh-noor-choker",
    name: "Surkh Noor Choker",
    category: "Festive Choker",
    style: "Necklaces",
    material: "925 Sterling Silver",
    price: 35999,
    oldPrice: 39999,
    rating: 5,
    desc: "Inspired by royal celebrations — sterling silver with a luminous gold finish, sparkling kundan settings and deep ruby-toned drops.",
    img: ["Surkh Noor Choker"],
    pics: ["/img/Surkh-Noor-Choker-2.png"],
    shopUrl: "https://shop.mahidha.com/product/surkh-noor-choker/",
  },
  {
    id: "nyra-drop-earrings",
    name: "Nyra Drop Earrings",
    category: "Heritage Earrings",
    style: "Earrings",
    material: "925 Sterling Silver",
    price: 10999,
    oldPrice: 12221,
    rating: 5,
    desc: "Filigree-inspired heritage drop earrings with deep ruby-hued stones and luminous freshwater pearls.",
    img: ["Nyra Drop Earrings"],
    pics: ["/img/Nyra-Drop-Earrings-4.png"],
    shopUrl: "https://shop.mahidha.com/product/nyra-drop-earrings/",
  },
];
...
export const ALL_JEWELRY_MEGA: MegaGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Elegant Finds Under ₹7000",
        href: `${S}/gifting/elegant-finds-under-%e2%82%b97000/`,
      },
    ],
  },
  {
